		...
		return (
			...
			>
				...
				<div className="w-64 py-1.5 flex items-center justify-center bg-ub-cool-grey hover:bg-ub-warm-grey hover:bg-opacity-20">
					<div className="w-8">
						<img width="16px" height="16px" src="./themes/Olshevskyi/status/audio-headphones-symbolic.svg" alt="ubuntu headphone" />
					</div>
					<Slider
				...
				<div className="w-64 py-1.5 flex items-center justify-center bg-ub-cool-grey hover:bg-ub-warm-grey hover:bg-opacity-20">
					<div className="w-8">
						<img width="16px" height="16px" src="./themes/Olshevskyi/status/display-brightness-symbolic.svg" alt="ubuntu brightness" />
					</div>
					<Slider
				...
				<div className="w-64 py-1.5 flex items-center justify-center bg-ub-cool-grey hover:bg-ub-warm-grey hover:bg-opacity-20">
					<div className="w-8">
						<img width="16px" height="16px" src="./themes/Olshevskyi/status/network-wireless-signal-good-symbolic.svg" alt="ubuntu wifi" />
					</div>
				...
				<div className="w-64 py-1.5 flex items-center justify-center bg-ub-cool-grey hover:bg-ub-warm-grey hover:bg-opacity-20">
					<div className="w-8">
						<img width="16px" height="16px" src="./themes/Olshevskyi/status/bluetooth-symbolic.svg" alt="ubuntu bluetooth" />
					</div>
					<div className="w-2/3 flex items-center justify-between text-gray-400">
						<span>Off</span>
						<SmallArrow angle="right" />
				...
				<div className="w-64 py-1.5 flex items-center justify-center bg-ub-cool-grey hover:bg-ub-warm-grey hover:bg-opacity-20">
					<div className="w-8">
						<img width="16px" height="16px" src="./themes/Olshevskyi/status/battery-good-symbolic.svg" alt="ubuntu battery" />
					</div>
					<div className="w-2/3 flex items-center justify-between text-gray-400">
				...
				>
					<div className="w-8">
						<img width="16px" height="16px" src="./themes/Olshevskyi/status/emblem-system-symbolic.svg" alt="ubuntu settings" />
					</div>
				...
				>
					<div className="w-8">
						<img width="16px" height="16px" src="./themes/Olshevskyi/status/changes-prevent-symbolic.svg" alt="ubuntu lock" />
					</div>
					<div className="w-2/3 flex items-center justify-between">
						<span>Lock</span>
					</div>
				...
				>
					<div className="w-8">
						<img width="16px" height="16px" src="./themes/Olshevskyi/status/system-shutdown-symbolic.svg" alt="ubuntu power" />
					</div>
					<div className="w-2/3 flex items-center justify-between">
